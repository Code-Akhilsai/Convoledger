...
const ProjectMemory = () => {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-10">
      <div>
        <h1 className="font-bold text-3xl text-gray-900 tracking-tight">Project Memory & Topics</h1>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {topicsList.map(([topic, convs]) => (
            <div
              key={topic}
              className="p-5 bg-white border border-purple-100 hover:border-purple-300 rounded-2xl shadow-xs space-y-3"
            >
